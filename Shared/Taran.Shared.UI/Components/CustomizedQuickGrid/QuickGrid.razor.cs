...
public partial class QuickGrid<TGridItem> : IAsyncDisposable
{
    ...
    private readonly RenderFragment _renderColumnHeadersOptions;
    ...
    public QuickGrid()
    {
        ...
        _renderColumnHeadersOptions = RenderColumnHeadersOptions;
    ...
    protected override Task OnParametersSetAsync()
    {
        ...
        {
            throw new InvalidOperationException($"QuickGrid requires one of {nameof(Items)} or {nameof(ItemsProvider)}, but both were specified.");
        }
    ...
    public async Task RefreshDataAsync()
    {
        ...
        try
        {
            ...
            if (OnSelectedChanged.HasDelegate)
                await OnSelectedChanged.InvokeAsync(_selectedItem);
        }
        catch { }
    ...
    private string GridClass()
    {
        ...
        return CombineClassNames(AdditionalAttributes, gridClass) ?? string.Empty;
    }
