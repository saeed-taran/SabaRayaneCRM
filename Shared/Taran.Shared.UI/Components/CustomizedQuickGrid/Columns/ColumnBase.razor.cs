...
{
    /// <summary>
    /// Structure for creating input for editing or creating new item
    /// </summary>
    [Parameter] public EditTemplate? EditTemplate { get; set; }

    [Parameter] public bool ContentIsHtml { get; set; }
    ...
    protected internal abstract string? GetCellContent(TGridItem item);
